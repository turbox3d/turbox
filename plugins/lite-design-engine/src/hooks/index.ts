...
export function useMaterialDragAndReplace<CustomBizData>(
  ...
  enableReplace = false,
  loadingImg = 'https://img.alicdn.com/imgextra/i1/O1CN01lIDPxa1JwdcySt495_!!6000000001093-55-tps-30-30.svg',
  maxFPS = 60
) {
  ...
  const getPickedProduct = (e: PointerEvent) => {
    ...
    if (point) {
      const viewEntity = SceneUtil.hitTarget(point) as IViewEntity;
