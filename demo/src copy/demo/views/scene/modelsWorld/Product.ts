...
import { MathUtils, Mesh3D, Reactive, reactive, Reaction, Vector3, Element, g } from '@byted-tx3d/turbox';

import { appCommandManager } from '../../../commands/index';
import { ClipPointSymbol, AdjustPointSymbol, DeletePointSymbol, RenderOrder } from '../../../common/consts/scene';
...
@Reactive
export class ProductViewEntity extends Mesh3D<IProps> {
